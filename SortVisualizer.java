...
/**
 * Class that visualizes sorting algorithms in the console. Creates a visual
 * representation of the sorting process as it happens.
 */
public class SortVisualizer {
    ...
    public static void main(String[] args) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (true) {
                ...
                int choice = getIntegerInput(scanner, 0, 7);
                ...
                switch (choice) {
                    case 1 ->
                        sorter = new algorithms.BubbleSort(array, bars, width, height, delay);
                    case 2 ->
                        sorter = new algorithms.SelectionSort(array, bars, width, height, delay);
                    case 3 ->
                        sorter = new algorithms.InsertionSort(array, bars, width, height, delay);
                    case 4 ->
                        sorter = new algorithms.MergeSort(array, bars, width, height, delay);
                    case 5 ->
                        sorter = new algorithms.QuickSort(array, bars, width, height, delay);
                    case 6 ->
                        sorter = new algorithms.HeapSort(array, bars, width, height, delay);
                    case 7 ->
                        sorter = new algorithms.RadixSort(array, bars, width, height, delay);
                }
    ...
    private static int[] getArrayInput(Scanner scanner) {
        ...
        return switch (option) {
            ...
            case 2 ->
                new int[]{64, 34, 25, 12, 22, 11, 90}; // Sample array
            case 3 -> {
                // Random array
